...
(function($) {
    ...
    const findEmojiMessages = () => $('.message .content').not('.msg-emoji').filter((i,v) => v.textContent.length <= 2 && emojiRegex.test(v.textContent || '')).addClass('msg-emoji');


    function initEmojiPicker() {

        const chatfield = $('#input');

        // Load emojionearea - https://github.com/mervick/emojionearea/tree/version2
        const liburl = 'https://cdn.rawgit.com/mervick/emojionearea/version2';
