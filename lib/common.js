...
(() => {
  ...
  const bannerOpts = {
    html: `We are <a target="_blank" class="s-link js-link fc-orange-400" href="https://openletter.mousetail.nl">calling for solidarity</a> against taken by Stack Overflow, Inc. which is posing a major threat to the integrity and trustworthiness of the platform and its content.`,
