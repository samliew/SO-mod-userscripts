...
const isElectionPage = location.pathname.startsWith('/election') || document.body.classList.contains('election-page');
 ...
 * @returns {boolean}
 */
const containsDiamondUnicode = str => str.includes('\u2666');
