...
const _userlinkRegex = /^\/(?:users(?:\/)?(?:account-info|history|preferences|flagged-posts|flag-summary|message\/create)?|admin(?:\/)?(?:cm-message\/create|(?:show|xref)-user-(?:votes|ips)))\/(-?\d+)/i;
