...
(() => {
  ...
  const bannerOpts = {
    html: `We are <a target="_blank" class="s-link js-link fw-bold fc-blue-300" href="https://openletter.mousetail.nl">calling for solidarity</a> against taken by Stack Overflow, Inc. which is posing a major threat to the integrity and trustworthiness of the platform and its content.`,
    ...
    // Chat
      ...
      const bannerEl2 = makeElemFromHtml(`
        <div class="user-container monologue js-announcement-banner">
          ...
          <div class="messages" class="background-color: lightgoldenrodyellow;">
