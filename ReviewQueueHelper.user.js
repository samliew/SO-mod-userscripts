...
function addReviewQueueStyles() {
    ...
    const styles_review = document.createElement('style');
    styles_review.setAttribute('data-somu', GM_info?.script.name);
    styles_review.innerHTML = `
.sidebar .ajax-loader,
#footer {
...
`;
    document.body.appendChild(styles_review);
}