...
(function() {
    ...
    function insertPostIds() {
        ...
        $('a.question-hyperlink, a.answer-hyperlink, .js-post-title-link, .originals-of-duplicate li > a, .originals-of-duplicate .js-originals-list > a').add(modQueuePostLinks)
